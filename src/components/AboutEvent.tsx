...
export function AboutEvent() {
  ...
  return (
    <section className="relative w-full bg-navy-950 py-20 sm:py-28">
      {/* Subtle top gradient */}
      <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-navy-900 to-transparent" />
      ...
      <div className="relative mx-auto max-w-4xl px-6 sm:px-8">
        ...
        <Reveal delay={100} className="mb-14">
          <p className="mx-auto max-w-2xl text-center text-base leading-relaxed text-cream-50/70 sm:text-lg">
            ...
            <span className="font-medium text-gold-200">SmartWills WasiatKu</span> — a significant
          ...
          {pillars.map((pillar, index) => {
            ...
            return (
              <Reveal key={pillar.title} delay={150 + index * 100}>
                <div className="glass-card group h-full rounded-2xl p-6 text-center transition-all duration-300 hover:border-gold-400/25 hover:bg-gold-400/5">
                  <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-gold-400/20 bg-gold-400/5 transition-all duration-300 group-hover:scale-110 group-hover:border-gold-400/40">
