  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#F8F3E8] py-20 sm:py-28">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 right-0 h-[350px] w-[350px] rounded-full bg-[#003C32]/[0.025] blur-[120px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-5xl px-6 sm:px-8">
        ...
        {/* Main Venue Card */}
        <Reveal delay={100}>
          <div className="overflow-hidden rounded-3xl border border-[#D9A441]/25 bg-white shadow-[0_20px_60px_rgba(0,60,50,0.08)]">
            ...
            {/* Gold Divider */}
            <div className="mx-6 h-px bg-gradient-to-r from-transparent via-[#D9A441]/60 to-transparent sm:mx-10" />
            ...
            <div className="px-6 py-8 sm:px-10 sm:py-10">
              <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                ...
                <div className="text-center md:text-left">
                  ...
                  {/* Venue Name */}
                  <h3 className="font-serif text-2xl font-bold leading-tight text-[#D9A441] sm:text-3xl">
                  ...
                  <p className="mt-3 flex items-center justify-center gap-1.5 text-sm text-[#000000]/60 md:justify-start">
                    <MapPin
                      className="h-4 w-4 flex-shrink-0 text-[#A96D18]"
                      strokeWidth={1.5}
                    />
                ...
                <a
                  ...
                  className="group inline-flex flex-shrink-0 items-center justify-center gap-2.5 rounded-full bg-[#D9A441] px-7 py-3.5 text-sm font-semibold text-[#F8F3E8] shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#8F1D1D] hover:shadow-lg active:translate-y-0"
                >
                  <Navigation
