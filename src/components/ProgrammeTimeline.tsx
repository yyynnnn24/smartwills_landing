          ...
          <div
            className={`z-10 mt-1 h-3 w-3 rounded-full border-2 transition-all duration-300 ${
              item.isMilestone
                ...
                : 'border-[#BF801F]/50 bg-[#003C32] group-hover:border-[#BF801F]/80'
            }`}
          />
        ...
        <div className="flex-1 pb-8">
          <div
            className={`rounded-xl p-4 transition-all duration-300 sm:p-5 ${
              item.isMilestone
                ? 'border border-[#BF801F]/25 bg-[#104836]/50 hover:border-[#BF801F]/40 hover:bg-[#104836]/65'
                : 'border border-[#F8F3E8]/[0.06] bg-[#104836]/25 hover:border-[#F8F3E8]/[0.10] hover:bg-[#104836]/45'
            }`}
          >
            <p
            ...
            {item.isMilestone && (
              <span className="mt-2 inline-block rounded-full bg-[#BF801F]/10 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-[#D9A441]">
                Key Ceremony
              </span>
            )}
          </div>
...
export function ProgrammeTimeline() {
  return (
    <section
      id="programme"
      className="relative w-full overflow-hidden bg-[#003C32] py-20 sm:py-28"
    >
      {/* Background atmosphere */}
      <div className="pointer-events-none absolute inset-0">
        {/* Main soft green glow */}
        <div className="absolute left-1/2 top-[-100px] h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-[#104836]/40 blur-[140px]" />

        {/* Gold glow on right */}
        <div className="absolute right-[-150px] top-[20%] h-[400px] w-[400px] rounded-full bg-[#BF801F]/[0.05] blur-[130px]" />

        {/* Green glow on left */}
        <div className="absolute left-[-180px] bottom-[10%] h-[400px] w-[400px] rounded-full bg-[#104836]/30 blur-[130px]" />

        {/* Bottom fade */}
        <div className="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-t from-[#003C32]/80 to-transparent" />
      ...
      <div className="relative mx-auto max-w-3xl px-6 sm:px-8">
        ...
        <Reveal className="mb-12 text-center">
          ...
          <p className="mt-4 inline-flex items-center gap-2 text-sm text-[#F8F3E8]/50">
            <Clock
              className="h-4 w-4 text-[#D9A441]/70"
              strokeWidth={1.5}
            />
