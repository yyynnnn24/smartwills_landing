...
function HighlightCard({ highlight, index }: { highlight: Highlight; index: number }) {
  ...
  return (
    <Reveal delay={index * 80}>
      <div className="group relative h-full overflow-hidden rounded-2xl border border-cream-50/8 bg-gradient-to-b from-navy-850/55 to-navy-950/55 p-6 transition-all duration-300 hover:border-gold-500/20 hover:from-navy-850/75 hover:to-navy-950/75 sm:p-7">
        {/* Number watermark */}
...
export function EventHighlights() {
  return (
    <section className="relative w-full bg-navy-600 py-20 sm:py-28">
